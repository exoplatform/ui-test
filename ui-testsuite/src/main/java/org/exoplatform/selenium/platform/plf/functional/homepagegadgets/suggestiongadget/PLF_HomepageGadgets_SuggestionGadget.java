...
public class PLF_HomepageGadgets_SuggestionGadget extends Activity{
	...
	public  void test02_03_Display2PeopleWithoutConnectionsInCommon() {
		...
		nav.goToHomePage();
		waitForAndGetElement(hGadget.ELEMENT_SUGGESTION_GADGET_FORM);
		waitForAndGetElement(hGadget.ELEMENT_VERIFY_USER_SUGGESTIONS.replace("${peopleName}", firstName4+" "+lastName4));
	 ...
	 * Pre-Condition: User A is 
	 * not connected to user B or C User A has a common connection with User C
	 * Post-Condition: 
	 * Done with OSs and browsers : 
	 * Generated by chinhdtt at 2014/02/10 08:46:52
	 */
	@Test
	public  void test04_08_Display2PeopleWithCommonConnections() {
		info("Test 4: Display 2 People with common connections - Case ID:79610");
		//Pre-Condition
		info("User A request");
		nav.goToConnectionPage();
	...
	public  void test09_DisplayButtonsJoinAndRevokeForSpaceSuggestion() {
		...
		waitForAndGetElement(hGadget.ELEMENT_JOIN_SPACE_SUGGESTIONS.replace("${spaceName}", nameSpace2),5000,1,2);
		waitForAndGetElement(hGadget.ELEMENT_REMOVE_SPACE_SUGGESTIONS.replace("${spaceName}", nameSpace2),5000,1,2);
		...
		waitForAndGetElement(hGadget.ELEMENT_REQUEST_SPACE_SUGGESTIONS.replace("${spaceName}", nameSpace1),5000,1,2);
		waitForAndGetElement(hGadget.ELEMENT_REMOVE_SPACE_SUGGESTIONS.replace("${spaceName}", nameSpace1),5000,1,2);
	 ...
	 * Done with OSs and browsers : 
	 * Generated by chinhdtt at 2014/02/10 08:46:52
	 * Bug: https://jira.exoplatform.org/browse/PLF-4411
	 * 
	 */
	@Test(groups="error")
