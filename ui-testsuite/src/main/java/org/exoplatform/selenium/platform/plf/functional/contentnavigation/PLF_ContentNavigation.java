...
public class PLF_ContentNavigation extends PlatformBase{
	...
	public  void test02_EditTheNavigationForm() {
		...
		act.chooseDrive(acme.ELEMENT_COLLABORATION_DRIVE);
		act.goToViewMode("Web");
		acme.goToNode("sites/acme/events/All");
		act.addItem2ActionBar("contentNavigation", act.ELEMENT_NAVIGATION_LINK);
		act.chooseDrive(acme.ELEMENT_COLLABORATION_DRIVE);
		act.goToViewMode("Web");
		acme.goToNode("sites/acme/events/All");	
		act.goToContentNavigation();
		click(act.ELEMENT_NAVIGATION_LINK);
		assert waitForAndGetElement(act.ELEMENT_PARENT_FOLDER_NODE).getAttribute("value").equalsIgnoreCase("all");
		click(act.ELEMENT_NAVIGATION_SELECT_NODE);
		waitForAndGetElement(act.ELEMENT_NAVIGATION_SELECTION_FORM);
	...
	public  void test03_AddANewContentUnderASubMenu() {
		...
		act.chooseDrive(acme.ELEMENT_COLLABORATION_DRIVE);
		act.goToViewMode("Web");
		acme.goToNode("sites/acme/events/All/Fire");
		act.addItem2ActionBar("manageActions", act.ELEMENT_ACTION_ICON, "Web");
		act.chooseDrive(acme.ELEMENT_COLLABORATION_DRIVE);
		act.goToViewMode("Web");
		acme.goToNode("sites/acme/events/All/Fire");
		...
		acme.goToNode("sites/acme/events/All/Fire/"+fileUpload);
		act.publishDocument();
		...
		act.goToViewMode("Web");
		acme.goToNode("sites/acme/events/All/Fire");
		cMenu.deleteDocument(By.linkText(fileUpload));
		act.goToAction();
	...
	public  void test04_CreateANewProduct() {
		...
		String image2 = "Sniff_public_activity_09.jpg";
		String video = "KS_Wiki_Attachment_AllMyLove.mp3";
		String pathContent = "General Drives/Collaboration/Sites Management/intranet/documents/"+titleName ;
		By bNode1= By.xpath(siteExp.ELEMENT_SE_NODE.replace("{$node}",titleName));
		...
		nav.goToSiteExplorer();
		act.goToNode("intranet/documents");
		...
		act.goToNode(titleName+"/medias/images");
		...
		mPage.deletePageAtManagePageAndPortalNavigation(nodeName, true, "acme", false, "Overview", displayName);
