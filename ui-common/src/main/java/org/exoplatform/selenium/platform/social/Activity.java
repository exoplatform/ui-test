...
public class Activity extends SocialBase {
	...
	public final String ELEMENT_USER_NAME_LIKE_THIS_ACTIVITY = "//*[contains(text(), '${activityText}')]//ancestor::div[contains(@id,'ActivityContextBox')]//*[contains(text(),'${userName} liked this')]";
