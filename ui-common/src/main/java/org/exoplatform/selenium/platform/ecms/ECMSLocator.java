...
public class ECMSLocator extends PlatformBase{
	...
	public final By ELEMENT_CONTEXT_MENU_ADD_DOCUMENT =By.xpath("(.//*[@id='JCRContextMenu']//*[contains(@href,'javascript:void(0)')])[3]");//By.xpath(".//*[@id='JCRContextMenu']//*[contains(@class,'uiIconEcmsAddDocument')]");
