...
public class AdministrationLocator extends PlatformBase{
	...
	public final String ELEMENT_ACTION_BUTTON = "//*[text()='$action']";
	public final String ELEMENT_DELETE_TOOLTIP = ".//*[contains(@id, '${tabName}')]//*[@data-original-title='Delete']";
	public final String ELEMENT_DELETE_BUTTON = ".//*[contains(@id, '${tabName}')]//*[@class='uiIconDelete uiIconLightGray']";
	
	//Site permission
	public final String ELEMENT_PERMISSION_SELECTOR = "//*[@id='PermissionSetting']//*[text() = '${tabName}']";
	public final String ELEMENT_PERMISSION_PUBLIC_MODE = "//*[contains(@id,'${tabName}')]//*[@for='publicMode' and text() = 'Everyone:']";
	public final String ELEMENT_PERMISSION_PUBLIC_MODE_CHECKBOX = "//*[contains(@id,'${tabName}')]//*[@id='publicMode']";
	public final String ELEMENT_PERMISSION_TABLE_COLUMN = "//*[contains(@id,'${tabName}')]//*[@id='PermissionGrid']//*[@id='${columnId}' and text()='${columnLabel}']";
	public final String ELEMENT_PERMISSION_ADD_USER_BUTTON = "//*[contains(@id,'${tabName}')]//*[@class='uiIconAddUser uiIconWhite']/..[contains(text(),'Add Permission')]";
    public final String ELEMENT_PERMISSION_TAB_NAME = "//*[@data-target='#PermissionSetting-tab' and text()='${tabName}']";
	
	public final String ELEMENT_CONTAINER_PERMISSION_SELECTOR = "//*[@id='UIContainerPermission']//*[text() = '${tabName}']";
	public final String ELEMENT_PERMISSION_ADD_USER_BTN = "//*[contains(@id,'${tabName}')]//*[@class='uiIconAddUser uiIconWhite']";
	public final String ELEMENT_PORTLET_SELECT_PERMISSION_POPUP = ".//*[contains(@id, '${tabName}')]//*[@class='PopupTitle popupTitle' and (text()='Select Permission' or text()='Group and Membership Selector')]";
	public final String ELEMENT_PORTLET_SELECT_PERMISSION_GROUP_MEMBERSHIP_NAME=".//*[contains(@id, '${tabName}')]//*[@class='PopupContent popupContent']//*[@title='${name}']";
	public final String ELEMENT_PORTLET_ACCESS_PERMISSION_GROUP_NAME=".//*[contains(@id, '${tabName}')]//*[@id='PermissionGrid']//*[contains(text(),'${group}')]";
	public final String ELEMENT_CONFIRM_DELETE_MESSAGE="Are you sure you want to delete this Access Group?";	
	public final String ELEMENT_PERMISSION_WARNING = "//*[contains(@id,'${tabName}')]//*[@id='PermissionGrid']//*[contains(text(),'Warning: nobody is granted this permission')]";
	
	public final By ELEMENT_APPLICATION_TAB_ACTIVE = By.xpath("//*[@data-target='#appList']");
	public final By ELEMENT_APPLICATION_CONTAINER = By.xpath("//*[@class='RightBodyTDContainer TDContainer']");
	public final By ELEMENT_PAGE_APPLICATION_CONTAINER = By.xpath("//*[@class='OfficeMiddleTDContainer TDContainer']");
	public final String ELEMENT_PORTLET_SELECT_PERMISSION_POPUP_TITLE = ".//*[contains(@id, '${tabName}')]//*[@class='PopupTitle popupTitle' and (text()='${popupTitle}')]";
	
	public final String ELEMENT_PERMISSION_ACCESS_TAB_ID = "TabContentUIListPermissionSelector";
	public final String ELEMENT_PERMISSION_MOVE_APPS_TAB_ID = "TabContentUIListMoveAppsPermissionSelector";
	public final String ELEMENT_PERMISSION_MOVE_CONTAINERS_TAB_ID = "TabContentUIListMoveContainersPermissionSelector";
	
	public final String ELEMENT_PERMISSION_ACCESS_POPUP_TAB_ID = "UIListPermissionSelectorPopup";
	public final String ELEMENT_PERMISSION_MOVE_APPS_POPUP_TAB_ID = "UIListMoveAppsPermissionSelectorPopup";
	public final String ELEMENT_PERMISSION_MOVE_CONTAINERS_POPUP_TAB_ID = "UIListMoveContainersPermissionSelectorPopup";
	...
	public final String ELEMENT_PERMISSION_TABLE = "//*[contains(@id,'${tabName}')]//*[@id='PermissionGrid']";	
	//Site's sub-menu
	public final String ELEMENT_EDITSITE_SUBMENU_LAYOUT = "Layout";
	public final String ELEMENT_EDITSITE_SUBMENU_NAVIGATION = "Navigation";
	public final String ELEMENT_EDITSITE_SUBMENU_ADDSITE = "Add Site";
	
	public final String PERMISSION_SELECTOR_ACCESS = "Access";
	public final String PERMISSION_SELECTOR_MOVE_APPS = "Move Apps";
