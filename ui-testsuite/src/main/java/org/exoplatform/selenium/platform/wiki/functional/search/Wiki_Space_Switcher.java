...
public class Wiki_Space_Switcher extends BasicAction{
	...
	public  void test01_WhenUserIsMemberOf0SpaceSpaceSwitcherShouldNotDisplaySpacesListAndInputText() {
		 ...
		 *Expected Outcome: 
				- Input text and space list are still displayed in the space switcher list*/ 
	...
	public  void test03_04_SearchShouldStartOnFirstCharactersInputedAndDisplayNoSpaces() {
		...
		String longNameSpace = "4Long title for a space name";
		magMember.goToMySpacePage();
		...
		magMember.deleteSpace("4Long title for", 300000);
	}
	...
	public  void test05_SearchIsWorkingAsAFilterInTheListOfSpaces() {
		...
		String longNameSpace = "5Long title for a space name";
		magMember.goToMySpacePage();	
		magMember.addNewSpace(mobileSpace, "");
		magMember.goToMySpacePage();
		magMember.addNewSpace(longNameSpace, "");
		...
		magMember.goToMySpacePage();	
		magMember.deleteSpace(mobileSpace,300000);
		magMember.deleteSpace("5Long title for", 300000);
	}
	...
	public  void test06_SearchIsNotCaseSensitive() {
		...
		String longNameSpace = "6Long title for a space name";
		magMember.goToMySpacePage();	
		magMember.addNewSpace(mobileSpace, "");
		magMember.goToMySpacePage();
		magMember.addNewSpace(longNameSpace, "");
		...
		magMember.goToMySpacePage();	
		magMember.deleteSpace(mobileSpace,300000);
		magMember.deleteSpace("6Long title for", 300000);
	}
	...
	public  void test07_SearchDoesntTakeIntoAccountOrderOfWords() {
		...
		String longNameSpace = "7Long title for a space name";
		magMember.goToMySpacePage();	
		magMember.addNewSpace(mobileSpace, "");
		magMember.goToMySpacePage();
		magMember.addNewSpace(longNameSpace, "");
		...
		magMember.goToMySpacePage();	
		magMember.deleteSpace(mobileSpace,300000);
		magMember.deleteSpace("7Long title for", 300000);
	}
	...
	public  void test08_SearchSpaceSwitcherIsScrollableWhenThereAreMoreThan10Results() {
		...
		String longNameSpace = "8Long title for a space name";
		...
		magMember.goToMySpacePage();	
		magMember.deleteSpace(mobileSpace,300000);
		magMember.deleteSpace("8Long title for", 300000);
		for (int i = 1; i < 12; i++) {
	...
	public  void test09_SearchShouldNotTakeIntoAccountSpacesAtTheEndOfATextInputted() {
		...
		String longNameSpace = "9Long title for a space name";
		magMember.goToMySpacePage();	
		magMember.addNewSpace(mobileSpace, "");
		magMember.goToMySpacePage();
		magMember.addNewSpace(longNameSpace, "");
		...
		magMember.goToMySpacePage();	
		magMember.deleteSpace(mobileSpace,300000);
		magMember.deleteSpace("9Long title for", 300000);
	}
	...
	public  void test10_SearchShouldTakeIntoAccountSpacesInTheMiddleOfTextInputted() {
		...
		String longNameSpace = "10Long title for a space name";
		magMember.goToMySpacePage();	
		magMember.addNewSpace(mobileSpace, "");
		magMember.goToMySpacePage();
		magMember.addNewSpace(longNameSpace, "");
		...
		waitForAndGetElement(ELEMENT_SPACE_SWITCHER_INPUT).sendKeys("10Long title");
		waitForAndGetElement(ELEMENT_SPACE_NAME_SELECTED.replace("${space}", longNameSpace.toLowerCase().replace(" ", "_")));
		/*Step number: 4
		 *Step Name: 
		 *Step Description: 
		 ...
		 *Expected Outcome: 
				...
				- "No Spaces"*/ 
		waitForAndGetElement(ELEMENT_SPACE_SWITCHER_INPUT_FOCUS).sendKeys("10Longtitle");
		waitForAndGetElement(ELEMENT_NO_SPACE_OPTION);
		Utils.pause(500);
		waitForAndGetElement(ELEMENT_SPACE_SWITCHER_INPUT_FOCUS).clear();
		waitForAndGetElement(ELEMENT_SPACE_SWITCHER_INPUT_FOCUS).sendKeys("10Long  title");
		waitForAndGetElement(ELEMENT_NO_SPACE_OPTION);

		//resote data
		magMember.goToMySpacePage();	
		magMember.deleteSpace(mobileSpace,300000);
		magMember.deleteSpace("10Long title for", 300000);
