...
public class Cloud_Features_NewUserActivity extends CloudBase{
	...
	public  void test01_02_06_07_08_09_ActivityShouldBeDisplayedWhenUserJoinsTheWorkspace() {
		...
		navBar.goToHomePage();
		info(message);
		info(waitForAndGetElement(hpActivity.ELEMENT_ACTIVITY_CONTENT_INDEX.replace("${index}", "1")).getText());
		assert waitForAndGetElement(hpActivity.ELEMENT_ACTIVITY_CONTENT_INDEX.replace("${index}", "1")).getText().contains(message);
		...
		info(shelfMessage);
		info(waitForAndGetElement(By.xpath("//div[1][contains(@id,'activityContainer')]//div[@class='text']")).getText());
		assert waitForAndGetElement(By.xpath("//div[1][contains(@id,'activityContainer')]//div[@class='text']")).getText().contains(shelfMessage);
	 ...
	 */
	@Test(groups="pending")
	public  void test03_ConnectActionShouldBeUpdatedToCancelConnectionRequest() {
	 ...
	 */
	@Test(groups="pending")
	public  void test04_CancelConnectionRequestActionShouldBeRemoved() {
		 ...
		 *Step Description: 
			- Connect with User A
			- From the Activity actions bar, click on the action link "Connect "
		 *Input Data: 
	 ...
	 */
	@Test(groups="pending")
	public  void test05_ConnectActionShouldBeUpdatedAcceptConnectionRequest() {
		 ...
		 *Expected Outcome: 
			- The action change to "Comment | Like | Accept Connection Request"*/ 
