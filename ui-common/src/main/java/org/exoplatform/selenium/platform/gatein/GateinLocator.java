...
public class GateinLocator extends PlatformBase {
  ...
  //Remote gadget on righ panel
	...
	public final By ELEMENT_SAVE_BUTTON_2 = By.xpath(".//*[@id='UIGroupMembershipForm']//*[contains(@class,'btn')]");
	...
	public final By ELEMENT_EDITING_CONTAINER_POPUP = By.xpath("//*[@id='UIMaskWorkspace']//*[contains(text(),'Container Setting')]");
	
	public final By ELEMENT_SITE_LAYOUT_CONTAINER_HOME_DELETE_ICON = By.xpath("//*[@id='RightBody']/div/div[2]/div/div[2]/a[2][@data-original-title='Delete Container']/i[@class='uiIconTrash uiIconWhite']");
	public final By ELEMENT_SITE_LAYOUT_CONTAINER_HOME = By.xpath("//*[@id='UIPageBody']/div/div[1]");
	public final By ELEMENT_SITE_LAYOUT_CONTAINER_NAVIGATION = By.xpath("//*[@class='UIRowContainer']//*[@class='portletLayoutDecorator' and contains(text(),'UIBreadCrumbsNavigationPortlet')]/ancestor::*[@class='LAYOUT-BLOCK LAYOUT-PORTLET']");
	public final By ELEMENT_SITE_LAYOUT_CONTAINER_PARENT_EDIT_ICON = By.xpath(".//*[@id='Officebody']/div/div[2]/div/div[2]/a[1][@data-original-title='Edit Table']/i[@class='uiIconEdit uiIconWhite']");
	public final String ELEMENT_SITE_LAYOUT_CONTAINER_BY_ID = "//*[@id='${id}']/div";
	public final String ELEMENT_SITE_LAYOUT_CONTAINER_PARENT_EDIT_ID = ".//*[@id='${id}']/div/div[2]/div/div[2]/a[1][@data-original-title='Edit Table']/i[@class='uiIconEdit uiIconWhite']";
	public final By ELEMENT_SITE_LAYOUT_CONTAINER_ADDED = By.xpath(".//*[@class='UIRowContainer EmptyContainer'][not(div)]");
	public final By ELEMENT_SITE_LAYOUT_CONTAINER_PARENT_DELETE = By.xpath(".//*[@id='NavigationBody']//*[@data-original-title='Delete Table']//*[@class='uiIconTrash uiIconWhite']");
	public final By ELEMENT_SITE_LAYOUT_CONTAINER_EMPTY_DRAGANDDROP = By.xpath(".//*[@class='UIRowContainer EmptyContainer'][not(div)]/../../..//*[@class='uiIconDragDrop uiIconWhite']");
	public final String ELEMENT_SITE_LAYOUT_CONTAINER_BY_ID_AND_CLASS = "//*[@id='${id}']//*[@class='${class}']";
	public final String ELEMENT_SITE_LAYOUT_DOCUMENTS_CONTAINER_EDIT = "//*[@id='DocumentContainer']/div//*[@data-original-title='Edit Container' and contains(@onclick, 'DocumentContainer')]/i";
	public final String ELEMENT_SITE_LAYOUT_LEFT_CONTAINER_EDIT = ".//*[@id='LeftNavigation']/div/div[2]/div/div[2]/a[1]/i";
	
	
	
	public final String ELEMENT_DELETE_PORTLET_ICON_BY_ID ="//*[@id='${id}']//*[@data-original-title='Delete Portlet']";
	
	//page editor
	final public By ELEMENT_PAGEEDITOR_CANCELBTN = By.xpath("//*[@class='btn' and text()='Cancel']");
	final public String ELEMENT_PAGEEDITOR_EDITELEMENT_BY_ID = "//*[@id='${id}']/div//*[@data-original-title='Edit Container']/i";

	
	public final String ELEMENT_PERMISSION_TAB = ".//*[@id='UIMaskWorkspace']//*[text()='Permissions']";
	public final String ELEMENT_PERMISSION_SELECTOR_BUTTON = ".//*[@class='uiAction uiActionBorder']//*[contains(text(),'Permission Selector')]";
}
